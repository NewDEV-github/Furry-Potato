...
public class R1S2_MAIN : DialogueLine {
    ...
    /// </summary>
    public override Array<string> Characters { get; set; } =
        new() { "Speaker", "Player", "Player", "Speaker", "Speaker" };
    ...
    public override Dictionary<string, string> Lines { get; set; } = new() {
        {
            ...
            "1",
            "To jest to. Moja szansa, żeby się pokazać. Muszę dać z siebie wszystko i nie zawieść. Nie mogę się stresować i popełnić błędu. Muszę się skupić na muzyce i cieszyć się nią..."
        }, {
            "2",
            "To było niesamowite. Czułem się jak w transie. Nie wiem, jak długo grałem, ale wydawało mi się, że to była wieczność. Czy podobało się to ludziom? Czy zrobiłem dobre wrażenie? Czy spełniłem oczekiwania?"
        }, {
            "3",
